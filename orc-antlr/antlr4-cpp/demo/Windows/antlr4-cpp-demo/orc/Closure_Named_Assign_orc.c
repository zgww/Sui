...
#include "Orc.h"
#include "Closure_Named_Assign_orc.h" 



// static struct 
typedef struct tagTest$__Closure_hi_10 Test$__Closure_hi_10;



struct tagTest$__Closure_hi_10 {
void  (*invoke)();
...
static void  Test$__fn___Closure_hi_10(Test$__Closure_hi_10 *  self);
static Test$__Closure_hi_10*  Test$__make___Closure_hi_10(Test$__Closure_hi_10 **  __outRef__);
...
void  Test$say(){
	URGC_VAR_CLEANUP void  (**hi)() = NULL;
	URGC_VAR_CLEANUP Test$__Closure_hi_10*  tmpReturn_1 = NULL;
	URGC_VAR_CLEANUP void  (**hi2)() = urgc_init_var((void**)&hi2, (urgc_set_var(&hi, Test$__make___Closure_hi_10(&tmpReturn_1) ) ));
	(*hi)() ;
	(*hi2)() ;
}
...
static Test$__Closure_hi_10*  Test$__make___Closure_hi_10(Test$__Closure_hi_10 **  __outRef__){
	URGC_VAR_CLEANUP Test$__Closure_hi_10*  self = urgc_init_var((void**)&self, malloc(sizeof(Test$__Closure_hi_10) ) );
	self->invoke = Test$__fn___Closure_hi_10;

...
void  Project_Mod$sayhi(){
	URGC_VAR_CLEANUP Project_Mod$User*  user = urgc_init_var((void**)&user, Project_Mod$User_new() );
	URGC_VAR_CLEANUP Project_Mod$User*  user2 = urgc_init_var((void**)&user2, Project_Mod$User_new() );
}

...
static void  __fn___Closure_291_45(SuiDesigner$__Closure_291_45 *  self, SuiCore$ViewBase *  v){
	...
	if (v->hover) {
		urgc_set_field_class(self->__var___Block_199_23->self->editCtx, (void * )offsetof(SuiDesigner$HoroEditCtx, hoverNode) , self->__var___Block_275_78->s) ;
	}
	else {
		urgc_set_field_class(self->__var___Block_199_23->self->editCtx, (void * )offsetof(SuiDesigner$HoroEditCtx, hoverNode) , NULL) ;
	}

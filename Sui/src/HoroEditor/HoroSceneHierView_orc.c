...
typedef struct tagHoroEditor$__Block_321_78 HoroEditor$__Block_321_78;
...
typedef struct tagHoroEditor$__Closure_312_42 HoroEditor$__Closure_312_42;

typedef struct tagHoroEditor$__Closure_318_42 HoroEditor$__Closure_318_42;

typedef struct tagHoroEditor$__Closure_321_30 HoroEditor$__Closure_321_30;

typedef struct tagHoroEditor$__Closure_337_45 HoroEditor$__Closure_337_45;

typedef struct tagHoroEditor$__Closure_hi_338 HoroEditor$__Closure_hi_338;
...
struct tagHoroEditor$__Block_321_78 {
	SuiDesigner$ANode*  s ;
};
...
struct tagHoroEditor$__Closure_312_42 {
	Orc$List*  (*invoke)(HoroEditor$__Closure_312_42 *  self, Object *  item);
	Vtable_Object *  vtable ;
};
...
struct tagHoroEditor$__Closure_318_42 {
	void  (*invoke)(HoroEditor$__Closure_318_42 *  self, SuiCore$Event *  e, SuiCore$Node *  n, Object *  item);
	Vtable_Object *  vtable ;
...
struct tagHoroEditor$__Closure_321_30 {
	void  (*invoke)(HoroEditor$__Closure_321_30 *  self, SuiCore$Node *  parentNode, Object *  item, int  deep);
	Vtable_Object *  vtable ;
...
struct tagHoroEditor$__Closure_337_45 {
	void  (*invoke)(HoroEditor$__Closure_337_45 *  self, SuiCore$ViewBase *  v);
	Vtable_Object *  vtable ;
	HoroEditor$__Block_246_23*  __var___Block_246_23 ;
	HoroEditor$__Block_321_78*  __var___Block_321_78 ;
};
...
struct tagHoroEditor$__Closure_hi_338 {
	void  (*invoke)(HoroEditor$__Closure_hi_338 *  self);
	Vtable_Object *  vtable ;
	HoroEditor$__Block_246_23*  __var___Block_246_23 ;
};
...
static void  __finiBlock___Block_321_78(HoroEditor$__Block_321_78 *  self);
...
static Orc$List*  __fn___Closure_312_42(Orc$List **  __outRef__, HoroEditor$__Closure_312_42 *  self, Object *  item);
static void  __fini___Closure_312_42(HoroEditor$__Closure_312_42 *  self);
static HoroEditor$__Closure_312_42*  __make___Closure_312_42(HoroEditor$__Closure_312_42 **  __outRef__);
static void  __fn___Closure_318_42(HoroEditor$__Closure_318_42 *  self, SuiCore$Event *  e, SuiCore$Node *  n, Object *  item);
static void  __fini___Closure_318_42(HoroEditor$__Closure_318_42 *  self);
static HoroEditor$__Closure_318_42*  __make___Closure_318_42(HoroEditor$__Closure_318_42 **  __outRef__, HoroEditor$__Block_246_23 *  __var___Block_246_23);
static void  __fn___Closure_321_30(HoroEditor$__Closure_321_30 *  self, SuiCore$Node *  parentNode, Object *  item, int  deep);
static void  __fini___Closure_321_30(HoroEditor$__Closure_321_30 *  self);
static HoroEditor$__Closure_321_30*  __make___Closure_321_30(HoroEditor$__Closure_321_30 **  __outRef__, HoroEditor$__Block_295_29 *  __var___Block_295_29, HoroEditor$__Block_246_23 *  __var___Block_246_23);
static void  __fn___Closure_337_45(HoroEditor$__Closure_337_45 *  self, SuiCore$ViewBase *  v);
static void  __fini___Closure_337_45(HoroEditor$__Closure_337_45 *  self);
static HoroEditor$__Closure_337_45*  __make___Closure_337_45(HoroEditor$__Closure_337_45 **  __outRef__, HoroEditor$__Block_246_23 *  __var___Block_246_23, HoroEditor$__Block_321_78 *  __var___Block_321_78);
static void  __fn___Closure_hi_338(HoroEditor$__Closure_hi_338 *  self);
static void  __fini___Closure_hi_338(HoroEditor$__Closure_hi_338 *  self);
static HoroEditor$__Closure_hi_338*  __make___Closure_hi_338(HoroEditor$__Closure_hi_338 **  __outRef__, HoroEditor$__Block_246_23 *  __var___Block_246_23);
...
void  HoroEditor$HoroSceneHierView$react(HoroEditor$HoroSceneHierView *  self, int  xxx){
	...
	URGC_VAR_CLEANUP_CLASS SuiView$ScrollArea*  tmpReturn_4 = NULL;
	{
		...
		URGC_VAR_CLEANUP_CLASS SuiView$TreeView*  tmpReturn_7 = NULL;
		{
			...
			URGC_VAR_CLEANUP HoroEditor$__Closure_312_42*  tmpReturn_9 = NULL;
			urgc_set_field(o->state, (void * )offsetof(SuiView$TreeState, getItemChildren) , __make___Closure_312_42(&tmpReturn_9) ) ;
			...
			urgc_set_field(o, (void * )offsetof(SuiView$TreeView, cbOnEvent_forItemView) , __make___Closure_318_42(&tmpReturn_10, __var___Block_246_23) ) ;
			URGC_VAR_CLEANUP HoroEditor$__Closure_321_30*  tmpReturn_11 = NULL;
			urgc_set_field(o, (void * )offsetof(SuiView$TreeView, reactItem) , __make___Closure_321_30(&tmpReturn_11, __var___Block_295_29, __var___Block_246_23) ) ;
		}
	}
...
static void  __finiBlock___Block_321_78(HoroEditor$__Block_321_78 *  self){
	urgc_set_field_class(self, (void * )offsetof(HoroEditor$__Block_321_78, s) , NULL) ;
	return urgc_free_later(self) ; 
}
...
static HoroEditor$__Closure_312_42*  __make___Closure_312_42(HoroEditor$__Closure_312_42 **  __outRef__){
	URGC_VAR_CLEANUP HoroEditor$__Closure_312_42*  self = (self=NULL,urgc_init_var((void**)&self, orc_alloc_and_set_deleter(sizeof(HoroEditor$__Closure_312_42) , __fini___Closure_312_42) ));
	self->invoke = __fn___Closure_312_42;
	self->vtable = orc_Vtable_Closure_init() ;
	return urgc_set_var_for_return((void ** )__outRef__, self) ; 
}
...
static void  __fini___Closure_318_42(HoroEditor$__Closure_318_42 *  self){
	urgc_set_field(self, (void * )offsetof(HoroEditor$__Closure_318_42, __var___Block_246_23) , NULL) ;
	urgc_free_later(self) ;
}
...
static HoroEditor$__Closure_318_42*  __make___Closure_318_42(HoroEditor$__Closure_318_42 **  __outRef__, HoroEditor$__Block_246_23 *  __var___Block_246_23){
	...
	self->vtable = orc_Vtable_Closure_init() ;
	urgc_set_field(self, (void * )offsetof(HoroEditor$__Closure_318_42, __var___Block_246_23) , __var___Block_246_23) ;
	return urgc_set_var_for_return((void ** )__outRef__, self) ; 
}

static void  __fn___Closure_321_30(HoroEditor$__Closure_321_30 *  self, SuiCore$Node *  parentNode, Object *  item, int  deep){
	URGC_VAR_CLEANUP HoroEditor$__Block_321_78*  __var___Block_321_78 = (__var___Block_321_78=NULL,urgc_init_var((void**)&__var___Block_321_78, orc_alloc_and_set_deleter(sizeof(HoroEditor$__Block_321_78) , __finiBlock___Block_321_78) ));
	SuiCore$Node *  o = parentNode;
	urgc_set_field_class(__var___Block_321_78, (void * )offsetof(HoroEditor$__Block_321_78, s) , (SuiDesigner$ANode* )item) ;
	int  idx = -1;
	...
	{
		SuiView$HoverViewEffect*  __scopeVar_333_20 = SuiView$mkHoverViewEffect(&tmpReturn_1, o, 0) , *o = __scopeVar_333_20;
		UNUSED DEFER(Orc_scopeExit) Orc$ScopeData __scopeObj_333_20 = ((SuiCore$Node*)o)->__exit__((void*)o);
	
		o->isActive = isSelected;
		URGC_VAR_CLEANUP HoroEditor$__Closure_337_45*  tmpReturn_2 = NULL;
		urgc_set_field(o, (void * )offsetof(SuiView$HoverViewEffect, cbOnHoverChanged) , __make___Closure_337_45(&tmpReturn_2, self->__var___Block_246_23, __var___Block_321_78) ) ;
	}
	bool  hasKids = __var___Block_321_78->s->children->size(__var___Block_321_78->s->children)  > 0;
	...
	{
		SuiView$ImageView*  __scopeVar_356_20 = SuiView$mkImageView(&tmpReturn_3, o, 0) , *o = __scopeVar_356_20;
		UNUSED DEFER(Orc_scopeExit) Orc$ScopeData __scopeObj_356_20 = ((SuiCore$Node*)o)->__exit__((void*)o);
	...
	{
		SuiView$TextView*  __scopeVar_380_20 = SuiView$mkTextView(&tmpReturn_6, o, 0) , *o = __scopeVar_380_20;
		...
		Vtable_Object *  vt = orc_getVtableByObject(__var___Block_321_78->s) ;
		URGC_VAR_CLEANUP_CLASS Orc$String*  name = (name=NULL,urgc_init_var_class((void**)&name, __var___Block_321_78->s->node ? __var___Block_321_78->s->node->name : NULL));
		if (name && Orc$String$notEmpty(name) ) {
			o->setText(o, name) ;
		}
		else {
			o->setText(o, __var___Block_321_78->s->tag) ;
		}
	}
}

static void  __fini___Closure_321_30(HoroEditor$__Closure_321_30 *  self){
	urgc_set_field(self, (void * )offsetof(HoroEditor$__Closure_321_30, __var___Block_295_29) , NULL) ;
	urgc_set_field(self, (void * )offsetof(HoroEditor$__Closure_321_30, __var___Block_246_23) , NULL) ;
	urgc_free_later(self) ;
}

static HoroEditor$__Closure_321_30*  __make___Closure_321_30(HoroEditor$__Closure_321_30 **  __outRef__, HoroEditor$__Block_295_29 *  __var___Block_295_29, HoroEditor$__Block_246_23 *  __var___Block_246_23){
	URGC_VAR_CLEANUP HoroEditor$__Closure_321_30*  self = (self=NULL,urgc_init_var((void**)&self, orc_alloc_and_set_deleter(sizeof(HoroEditor$__Closure_321_30) , __fini___Closure_321_30) ));
	self->invoke = __fn___Closure_321_30;
	self->vtable = orc_Vtable_Closure_init() ;
	urgc_set_field(self, (void * )offsetof(HoroEditor$__Closure_321_30, __var___Block_295_29) , __var___Block_295_29) ;
	urgc_set_field(self, (void * )offsetof(HoroEditor$__Closure_321_30, __var___Block_246_23) , __var___Block_246_23) ;
	return urgc_set_var_for_return((void ** )__outRef__, self) ; 
}

static void  __fn___Closure_337_45(HoroEditor$__Closure_337_45 *  self, SuiCore$ViewBase *  v){
	URGC_VAR_CLEANUP void  (**hi)(void *  self) = NULL;
	URGC_VAR_CLEANUP HoroEditor$__Closure_hi_338*  tmpReturn_1 = NULL;
	(urgc_set_var(&hi, __make___Closure_hi_338(&tmpReturn_1, self->__var___Block_246_23) ) );
	if (v->hover) {
		urgc_set_field_class(self->__var___Block_246_23->self->editCtx, (void * )offsetof(HoroEditor$HoroEditCtx, hoverNode) , self->__var___Block_321_78->s) ;
	}
	else {
...
static void  __fini___Closure_337_45(HoroEditor$__Closure_337_45 *  self){
	urgc_set_field(self, (void * )offsetof(HoroEditor$__Closure_337_45, __var___Block_246_23) , NULL) ;
	urgc_set_field(self, (void * )offsetof(HoroEditor$__Closure_337_45, __var___Block_321_78) , NULL) ;
	urgc_free_later(self) ;
}

static HoroEditor$__Closure_337_45*  __make___Closure_337_45(HoroEditor$__Closure_337_45 **  __outRef__, HoroEditor$__Block_246_23 *  __var___Block_246_23, HoroEditor$__Block_321_78 *  __var___Block_321_78){
	URGC_VAR_CLEANUP HoroEditor$__Closure_337_45*  self = (self=NULL,urgc_init_var((void**)&self, orc_alloc_and_set_deleter(sizeof(HoroEditor$__Closure_337_45) , __fini___Closure_337_45) ));
	self->invoke = __fn___Closure_337_45;
	self->vtable = orc_Vtable_Closure_init() ;
	urgc_set_field(self, (void * )offsetof(HoroEditor$__Closure_337_45, __var___Block_246_23) , __var___Block_246_23) ;
	urgc_set_field(self, (void * )offsetof(HoroEditor$__Closure_337_45, __var___Block_321_78) , __var___Block_321_78) ;
	return urgc_set_var_for_return((void ** )__outRef__, self) ; 
}
...
static void  __fini___Closure_hi_338(HoroEditor$__Closure_hi_338 *  self){
	urgc_set_field(self, (void * )offsetof(HoroEditor$__Closure_hi_338, __var___Block_246_23) , NULL) ;
	urgc_free_later(self) ;
}

static HoroEditor$__Closure_hi_338*  __make___Closure_hi_338(HoroEditor$__Closure_hi_338 **  __outRef__, HoroEditor$__Block_246_23 *  __var___Block_246_23){
	URGC_VAR_CLEANUP HoroEditor$__Closure_hi_338*  self = (self=NULL,urgc_init_var((void**)&self, orc_alloc_and_set_deleter(sizeof(HoroEditor$__Closure_hi_338) , __fini___Closure_hi_338) ));
	self->invoke = __fn___Closure_hi_338;
	self->vtable = orc_Vtable_Closure_init() ;
	urgc_set_field(self, (void * )offsetof(HoroEditor$__Closure_hi_338, __var___Block_246_23) , __var___Block_246_23) ;
	return urgc_set_var_for_return((void ** )__outRef__, self) ; 
}

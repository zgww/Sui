...
// static struct 
typedef struct tagSuiDesigner$__Block_40_18 SuiDesigner$__Block_40_18;

typedef struct tagSuiDesigner$__Closure_45_30 SuiDesigner$__Closure_45_30;



struct tagSuiDesigner$__Block_40_18 {
...
struct tagSuiDesigner$__Closure_45_30 {
	bool  (*invoke)(SuiDesigner$__Closure_45_30 *  self);
	Vtable_Object *  vtable ;
	SuiDesigner$__Block_40_18*  __var___Block_40_18 ;
};
...
static void  __finiBlock___Block_40_18(SuiDesigner$__Block_40_18 *  self);
static bool  __fn___Closure_45_30(SuiDesigner$__Closure_45_30 *  self);
static void  __fini___Closure_45_30(SuiDesigner$__Closure_45_30 *  self);
static SuiDesigner$__Closure_45_30*  __make___Closure_45_30(SuiDesigner$__Closure_45_30 **  __outRef__, SuiDesigner$__Block_40_18 *  __var___Block_40_18);
...
void SuiDesigner$InvalidReact_initMeta(Vtable_SuiDesigner$InvalidReact *pvt){
	...
	orc_metaField_method(&pNext, "setReactName", offsetof(SuiDesigner$InvalidReact, setReactName));
...
void SuiDesigner$InvalidReact_init_fields(SuiDesigner$InvalidReact *self){
	...
	((SuiDesigner$InvalidReact*)self)->setReactName = (void*)SuiDesigner$InvalidReact$setReactName;
...
void  SuiDesigner$InvalidReact$invalid(SuiDesigner$InvalidReact *  self){
	URGC_VAR_CLEANUP SuiDesigner$__Block_40_18*  __var___Block_40_18 = (__var___Block_40_18=NULL,urgc_init_var((void**)&__var___Block_40_18, orc_alloc_and_set_deleter(sizeof(SuiDesigner$__Block_40_18) , __finiBlock___Block_40_18) ));
	urgc_set_field_class(__var___Block_40_18, (void * )offsetof(SuiDesigner$__Block_40_18, self) , self) ;
	if (self->_reactDirty) {
		return ; 
	}
	self->_reactDirty = true;
	URGC_VAR_CLEANUP SuiDesigner$__Closure_45_30*  tmpReturn_1 = NULL;
	SuiCore$requestAnimationFrame(__make___Closure_45_30(&tmpReturn_1, __var___Block_40_18) ) ;
}



static void  __finiBlock___Block_40_18(SuiDesigner$__Block_40_18 *  self){
	urgc_set_field_class(self, (void * )offsetof(SuiDesigner$__Block_40_18, self) , NULL) ;
	return urgc_free_later(self) ; 
}

static bool  __fn___Closure_45_30(SuiDesigner$__Closure_45_30 *  self){
	self->__var___Block_40_18->self->_reactDirty = false;
	if (self->__var___Block_40_18->self->react) {
		(*(self->__var___Block_40_18->self->react))((void * )(self->__var___Block_40_18->self->react)) ;
	}
	else if (self->__var___Block_40_18->self->target) {
		void  (**pReact)(Object *  obj);
		OrcMetaField *  mf = orc_getMetaFieldByObject(self->__var___Block_40_18->self->target, self->__var___Block_40_18->self->reactName->str) ;
		if (mf) {
			pReact = OrcMetaField_getPtr(mf, self->__var___Block_40_18->self->target) ;
			if (*pReact) {
				(*pReact)(self->__var___Block_40_18->self->target) ;
			}
		}
	}
	return true; 
...
static void  __fini___Closure_45_30(SuiDesigner$__Closure_45_30 *  self){
	urgc_set_field(self, (void * )offsetof(SuiDesigner$__Closure_45_30, __var___Block_40_18) , NULL) ;
	urgc_free_later(self) ;
}

static SuiDesigner$__Closure_45_30*  __make___Closure_45_30(SuiDesigner$__Closure_45_30 **  __outRef__, SuiDesigner$__Block_40_18 *  __var___Block_40_18){
	URGC_VAR_CLEANUP SuiDesigner$__Closure_45_30*  self = (self=NULL,urgc_init_var((void**)&self, orc_alloc_and_set_deleter(sizeof(SuiDesigner$__Closure_45_30) , __fini___Closure_45_30) ));
	self->invoke = __fn___Closure_45_30;
	self->vtable = orc_Vtable_Closure_init() ;
	urgc_set_field(self, (void * )offsetof(SuiDesigner$__Closure_45_30, __var___Block_40_18) , __var___Block_40_18) ;

...
//vtable instance
Vtable_SuiDesigner$InspView _vtable_SuiDesigner$InspView;

// init meta

void SuiDesigner$InspView_initMeta(Vtable_SuiDesigner$InspView *pvt){
    OrcMetaField **pNext = &((Vtable_Object*)pvt)->headMetaField;//without super fields
	
	orc_metaField_class(&pNext, "inspector", ((Vtable_Object*)Vtable_SuiDesigner$Insp_init(0)), offsetof(SuiDesigner$InspView, inspector), true, false, 1);
...
Vtable_SuiDesigner$InspView* Vtable_SuiDesigner$InspView_init(Vtable_SuiDesigner$InspView* pvt){
    if (pvt == NULL){
        pvt = &_vtable_SuiDesigner$InspView;
    }
    ...
    ((Vtable_Object*)pvt)->make = (void*)&SuiDesigner$InspView_new;
    ((Vtable_Object*)pvt)->className = "SuiDesigner$InspView";

    ((Vtable_Object*)pvt)->initMeta = (void*)SuiDesigner$InspView_initMeta;
...
void SuiDesigner$InspView_init_fields(SuiDesigner$InspView *self){
    ...
    ((Object*)self)->fini = (void*)SuiDesigner$InspView_fini;
	//fields
    {
	URGC_VAR_CLEANUP_CLASS SuiDesigner$Insp*  tmpNewOwner_1 = NULL;
	urgc_set_field_class(self, (void**)&((SuiDesigner$InspView*)self)->inspector, SuiDesigner$Insp_new(&tmpNewOwner_1) );
    }
	((SuiCore$Listener*)self)->onListenerEvent = (void*)SuiDesigner$InspView$onListenerEvent;
	((SuiCore$Node*)self)->onMounted = (void*)SuiDesigner$InspView$onMounted;
	((SuiCore$Node*)self)->onUnmounting = (void*)SuiDesigner$InspView$onUnmounting;
	((SuiCore$Node*)self)->react = (void*)SuiDesigner$InspView$react;
}

// init function

void SuiDesigner$InspView_init(SuiDesigner$InspView *self, void *pOwner){
    Vtable_SuiDesigner$InspView_init(&_vtable_SuiDesigner$InspView);

    ((Object*)self)->vtable = (void*)&_vtable_SuiDesigner$InspView;
	...
	*((void**)pOwner) = self;
    ...
    SuiDesigner$InspView_init_fields(self);
...
SuiDesigner$InspView * SuiDesigner$InspView_new(void *pOwner){
    ...
    SuiDesigner$InspView *self = ORC_CALLOC(1, sizeof(SuiDesigner$InspView));
	
    SuiDesigner$InspView_init(self, pOwner);
    return self;
}
...
void  SuiDesigner$InspView$react(SuiDesigner$InspView *  self){
	...
	if (!(Orc_instanceof((Object*)obj, (Vtable_Object*)Vtable_SuiDesigner$ANode_init(NULL)))) {
		...
		URGC_VAR_CLEANUP_CLASS SuiView$ScrollArea*  tmpReturn_6 = NULL;
		{
			...
			if (anode && anode->node) {
				self->inspector->insp(self->inspector, o, anode->node) ;
			}
			else {
...
SuiDesigner$InspView*  SuiDesigner$mkInspView(SuiDesigner$InspView **  __outRef__, void *  parent, long long  key){
	...
	return urgc_set_var_for_return_class((void ** )__outRef__, (SuiDesigner$InspView* )SuiView$gocNode(&tmpReturn_1, sp, (SuiCore$Node * )parent, Vtable_SuiDesigner$InspView_init(NULL)) ) ; 
}

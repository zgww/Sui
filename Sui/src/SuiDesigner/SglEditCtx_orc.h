...
typedef struct tagSuiDesigner$EventSglSceneChanged SuiDesigner$EventSglSceneChanged;
typedef struct tagVtable_SuiDesigner$EventSglSceneChanged Vtable_SuiDesigner$EventSglSceneChanged;
typedef struct tagSuiDesigner$EventSglSelectedChanged SuiDesigner$EventSglSelectedChanged;
typedef struct tagVtable_SuiDesigner$EventSglSelectedChanged Vtable_SuiDesigner$EventSglSelectedChanged;
typedef struct tagSuiDesigner$SglEditCtx SuiDesigner$SglEditCtx;
typedef struct tagVtable_SuiDesigner$SglEditCtx Vtable_SuiDesigner$SglEditCtx;


#ifndef define_struct___SuiDesigner__SglEditCtx_orc_h__
#define define_struct___SuiDesigner__SglEditCtx_orc_h__


#ifdef INCLUDE_ONLY_TYPE
#define INCLUDE_ONLY_TYPE___SuiDesigner__SglEditCtx_orc_h__
#endif
...
#ifdef INCLUDE_ONLY_TYPE___SuiDesigner__SglEditCtx_orc_h__
...
#ifndef __SuiDesigner__SglEditCtx_orc_h__
#define __SuiDesigner__SglEditCtx_orc_h__
...
// 虚表
struct tagVtable_SuiDesigner$EventSglSceneChanged {
	Vtable_SuiCore$Event super;
};
//虚表实例
extern Vtable_SuiDesigner$EventSglSceneChanged _vtable_SuiDesigner$EventSglSceneChanged;

// class refc:0
struct tagSuiDesigner$EventSglSceneChanged {
	SuiCore$Event super; 
...
// 虚表
struct tagVtable_SuiDesigner$EventSglSelectedChanged {
	Vtable_SuiCore$Event super;
};
//虚表实例
extern Vtable_SuiDesigner$EventSglSelectedChanged _vtable_SuiDesigner$EventSglSelectedChanged;

// class refc:0
struct tagSuiDesigner$EventSglSelectedChanged {
	SuiCore$Event super; 
...
// 虚表
struct tagVtable_SuiDesigner$SglEditCtx {
	Vtable_Object super;
};
//虚表实例
extern Vtable_SuiDesigner$SglEditCtx _vtable_SuiDesigner$SglEditCtx;

// class refc:0
struct tagSuiDesigner$SglEditCtx {
	Object super; 
	SuiView$TreeState*  state ;
	Sgl$SglSceneView*  sceneView ;
	Orc$List*  roots ;
	SuiCore$Node*  hoverNode ;
	void  (*setState) (SuiDesigner$SglEditCtx *  self, SuiView$TreeState*  state);
	void  (*onSelectedChanged) (SuiDesigner$SglEditCtx *  self);
	void  (*setSceneView) (SuiDesigner$SglEditCtx *  self, Sgl$SglSceneView *  sceneView);
	Sgl$Scene *  (*getScene) (SuiDesigner$SglEditCtx *  self);
};

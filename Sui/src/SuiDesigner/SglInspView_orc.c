...
//vtable instance
Vtable_SuiDesigner$SglInspView _vtable_SuiDesigner$SglInspView;

// init meta

void SuiDesigner$SglInspView_initMeta(Vtable_SuiDesigner$SglInspView *pvt){
    OrcMetaField **pNext = &((Vtable_Object*)pvt)->headMetaField;//without super fields
	
	orc_metaField_class(&pNext, "insp", ((Vtable_Object*)Vtable_SuiDesigner$Insp_init(0)), offsetof(SuiDesigner$SglInspView, insp), true, false, 1);
	orc_metaField_class(&pNext, "editCtx", ((Vtable_Object*)Vtable_SuiDesigner$SglEditCtx_init(0)), offsetof(SuiDesigner$SglInspView, editCtx), true, false, 1);
...
Vtable_SuiDesigner$SglInspView* Vtable_SuiDesigner$SglInspView_init(Vtable_SuiDesigner$SglInspView* pvt){
    if (pvt == NULL){
        pvt = &_vtable_SuiDesigner$SglInspView;
    }
    ...
    ((Vtable_Object*)pvt)->make = (void*)&SuiDesigner$SglInspView_new;
    ((Vtable_Object*)pvt)->className = "SuiDesigner$SglInspView";

    ((Vtable_Object*)pvt)->initMeta = (void*)SuiDesigner$SglInspView_initMeta;
...
void SuiDesigner$SglInspView_init_fields(SuiDesigner$SglInspView *self){
    ...
    ((Object*)self)->fini = (void*)SuiDesigner$SglInspView_fini;
	//fields
    {
	URGC_VAR_CLEANUP_CLASS SuiDesigner$Insp*  tmpNewOwner_1 = NULL;
	urgc_set_field_class(self, (void**)&((SuiDesigner$SglInspView*)self)->insp, SuiDesigner$Insp_new(&tmpNewOwner_1) );
	urgc_set_field_class(self, (void**)&((SuiDesigner$SglInspView*)self)->editCtx, NULL);
    }
	((SuiCore$Listener*)self)->onListenerEvent = (void*)SuiDesigner$SglInspView$onListenerEvent;
	((SuiCore$Node*)self)->onMounted = (void*)SuiDesigner$SglInspView$onMounted;
	((SuiCore$Node*)self)->onUnmounting = (void*)SuiDesigner$SglInspView$onUnmounting;
	((SuiCore$Node*)self)->react = (void*)SuiDesigner$SglInspView$react;
}

// init function

void SuiDesigner$SglInspView_init(SuiDesigner$SglInspView *self, void *pOwner){
    Vtable_SuiDesigner$SglInspView_init(&_vtable_SuiDesigner$SglInspView);

    ((Object*)self)->vtable = (void*)&_vtable_SuiDesigner$SglInspView;
	...
	*((void**)pOwner) = self;
    ...
    SuiDesigner$SglInspView_init_fields(self);
		...
		if (!(Orc_instanceof((Object*)node, (Vtable_Object*)Vtable_Sgl$Obj3d_init(NULL)))) {
			...
			URGC_VAR_CLEANUP_CLASS SuiView$ScrollArea*  tmpReturn_6 = NULL;
			{
				...
				if (obj) {
					...
					{
						SuiView$TextView*  __scopeVar_120_24 = SuiView$mkTextView(&tmpReturn_9, o, 0) , *o = __scopeVar_120_24;
						UNUSED DEFER(Orc_scopeExit) Orc$ScopeData __scopeObj_120_24 = ((SuiCore$Node*)o)->__exit__((void*)o);
...
SuiDesigner$SglInspView*  SuiDesigner$mkSglInspView(SuiDesigner$SglInspView **  __outRef__, void *  parent, long long  key){
	...
	return urgc_set_var_for_return_class((void ** )__outRef__, (SuiDesigner$SglInspView* )SuiView$gocNode(&tmpReturn_1, sp, (SuiCore$Node * )parent, Vtable_SuiDesigner$SglInspView_init(NULL)) ) ; 
}

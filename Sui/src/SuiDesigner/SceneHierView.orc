...
class SceneHierView extends LayoutLinear {
    void ctor(){
        super.ctor()
    }
        ...
        if item instanceof ANode {
            ...
            mkMenuNativeItem(null, null, null).{
                ^void onActive(MenuNativeItem*item){
                    ...
                    self._routeRightMenu(item, anode)
    ...
    void react(int xxx){
        ...
        SceneHierView* o = (SceneHierView*)self
        ...
        mkScrollArea(o, 0)~{
            ...
            mkTreeView(o, 0)~{
                ...
                ctx.setState(o.state)
                o.state.roots = ctx.roots
                ...
                o.reactItem = ^void (Node *parentNode, Object *item, int deep){
                    ...
                    mkHoverViewEffect(o, 0)~{
                        ...
                        o.cbOnHoverChanged = ^void(ViewBase*v){
                            ...
                            if (v.hover){
                                EditCtx_ins().hoverNode = s
                            } else {
                                EditCtx_ins().hoverNode = null
                            }
                            // self.invalidDraw()
...
SceneHierView@ mkSceneHierView(void* parent, long long key){
    void *addr =  __builtin_return_address(0)
    void *sp = key ? (void*)key: addr
    return (SceneHierView@)gocNode(sp, (Node*)parent, SceneHierView)
}

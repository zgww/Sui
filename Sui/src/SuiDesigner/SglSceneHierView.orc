...
class SglSceneHierView extends LayoutLinear {
    ...
    void onListenerEvent(Event *event){
        if event instanceof EventSglSceneChanged{
            self.trigger_react()
        }
    }
    void onMounted(){
    ...
    void react(int xxx){
        ...
        SglSceneHierView* o = (SglSceneHierView*)self
        ...
        mkScrollArea(o, 0).{
            ...
            //     o.setText(str("你好啊 SglSceneHierView"))
            //     o.color = 0xffffffff
            // }
...
SglSceneHierView@ mkSglSceneHierView(void* parent, long long key){
    void *addr =  __builtin_return_address(0)
    void *sp = key ? (void*)key: addr
    return (SglSceneHierView@)gocNode(sp, (Node*)parent, SglSceneHierView)
}


void testSglSceneHier(){
    // registerNodes()

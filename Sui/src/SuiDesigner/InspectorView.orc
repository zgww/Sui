...
class InspectorView extends LayoutLinear{
...
InspectorView@ mkInspectorView(void* parent, long long key){
    void *addr =  __builtin_return_address(0)
    void *sp = key ? (void*)key: addr
    return (InspectorView@)gocNode(sp, (Node*)parent, InspectorView)
}
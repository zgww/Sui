...
static
void processMesh(Sgl$ModelLoader *  self, aiMesh *mesh, const aiScene *scene)
{
...
static void processNode(Sgl$ModelLoader *  self, aiNode* node, const aiScene * scene, int deep){
...
void  Sgl$ModelLoader$_load(Sgl$ModelLoader *  self){

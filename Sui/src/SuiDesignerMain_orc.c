...
void  testTransparency(){
	...
	URGC_VAR_CLEANUP_CLASS SuiLayout$LayoutAlign*  tmpNewOwner_1 = NULL;
	{
		...
		UNUSED DEFER(Orc_scopeExit) Orc$ScopeData __scopeObj_1247_4 = ((SuiCore$Node*)o)->__exit__((void*)o);
		...
		{
			SuiCore$View*  __scopeVar_1254_8 = SuiView$mkView(&tmpReturn_2, o, 0) , *o = __scopeVar_1254_8;
			UNUSED DEFER(Orc_scopeExit) Orc$ScopeData __scopeObj_1254_8 = ((SuiCore$Node*)o)->__exit__((void*)o);
		...
		URGC_VAR_CLEANUP_CLASS SuiView$TextView*  tmpReturn_3 = NULL;
		{
			SuiView$TextView*  __scopeVar_1259_8 = SuiView$mkTextView(&tmpReturn_3, o, 0) , *o = __scopeVar_1259_8;

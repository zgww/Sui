...
#define URGC_RETURN_CLASS(VAR) (urgc_set_var_for_return_class((void**)__outRef__, (Object*)VAR), VAR)
...
public:
    ...
    void* source = &target;//(void*)ROOT_REF; // 上级
    //void* source = this;//(void*)ROOT_REF; // 上级
};
#endif

...
//}
//
//bool Path_isDirectory(char const* path) {
//    std::filesystem::path p(toutf16(path));
//    auto ret = std::filesystem::is_directory(p);
//    return ret;
//    // _dirType = ret ? 1 : 0;
//}
//bool Path_mkdirs(char const* dirpath) {
...
//    return ret;
//}
//bool Path_copyTo(char const* src, char const* dst) {
//    std::filesystem::path p(toutf16(src));
//    std::filesystem::path np(toutf16(dst));
//    std::filesystem::copy(p, np);
//    return true;
//}
//bool Path_rename(char const* src, char const* dst) {
//    std::filesystem::path p(toutf16(src));
//    std::filesystem::path np(toutf16(dst));
//    std::filesystem::rename(p, np);
//    return true;
//}
//bool Path_remove(char const* src) {
//    std::filesystem::path p(toutf16(src));
//    std::filesystem::remove_all(p);
//    return true;
//}
//bool Path_removeDir(char const* src) {
//    if (Path_isDirectory(src)) {
//        std::filesystem::path p(toutf16(src));
//        std::filesystem::remove(p);
//    }
//    return true;
//}
//bool Path_removeDirs(char const* src) {
//    if (Path_isDirectory(src)) {
//        std::filesystem::path p(toutf16(src));
//        std::filesystem::remove_all(p);
//    }
...
//
//}
//bool Path_removeFile(char const* src) {
//    if (Path_isFile(src)) {
//        std::filesystem::path p(toutf16(src));
//        std::filesystem::remove(p);
//    }
//    return true;
//}
//bool Path_touch(char const* src) {
//    if (!Path_exists(src)) {
...
//    return true;
//}
//bool Path_fopen(char const* src, const char* mode) {
//    auto acpPath = toacp(src);
